<x-layout title="About Us">
  ...
  <section class="flex items-center justify-center w-[1000px] h-[500px] md:h-[500px] mx-auto">
  ...
  <section class="px-10 pb-10">
    ...
    <h3 class="font-bold text-2xl text-green-800 tracking-wide my-2">Our Vision</h3>
    <div class="text-medium text-justify mb-2 text-gray-600 font-semibold">
    ...
    <h3 class="font-bold text-2xl text-green-800 tracking-wide my-2">Our Mission</h3>
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
      ...
      <div>
        ...
        <div class="text-medium text-justify mb-2 text-gray-600 font-semibold pr-10">
  ...
  <h1 class="bg-green-700 p-5 rounded text-white text-xl font-bold tracking-wide text-center mb-2">REFAMED CARES</h1>
